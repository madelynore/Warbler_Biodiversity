...
knitr::opts_chunk$set(message = T) # Hide messages
knitr::opts_chunk$set(warning = T) # Hide warnings
knitr::opts_chunk$set(error = T )     # Hide errors
...
#separate vcfs
```{bash create-vcf-spp/time, eval=F}
...
```{bash calculate-diversity-stats, eval=F}
...
```{r function-bootstrap-downsample}
